<script lang="ts">
  ...
  function handleSave(html: string, css: string) {
    console.log('Saving back design:', { html, css });
    // TODO: Implement API call to save design
  }
</script>

<svelte:head>
  <title>Edit Back Design · {data.component.name} · Deckle</title>
  <meta name="description" content="Design the back of {data.component.name}" />
</svelte:head>
